...
with open('/home/koen/Documents/NaturalLanguageProcessing/Project/NLP1/nl-ud-dev.conllu', 'r', newline='\n') as f:
...
with open('/home/koen/Documents/NaturalLanguageProcessing/Project/NLP1/nl-ud-test.conllu', 'r', newline='\n') as f:
    reader = csv.reader(f, delimiter='\t', quoting=csv.QUOTE_ALL)
    for row in tqdm(reader):
        time.sleep(1e-10)
        if len(row) != 0:
...
with open('/home/koen/Documents/NaturalLanguageProcessing/Project/NLP1/nl-ud-train.conllu', 'r', newline='\n') as f:
    reader = csv.reader(f, delimiter='\t', quoting=csv.QUOTE_ALL)
    for row in tqdm(reader):
        time.sleep(1e-10)
        if len(row) != 0:
